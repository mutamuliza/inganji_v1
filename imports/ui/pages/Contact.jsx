...
function Contact() {
  return (
    <div className='Contact' style={{backgroundColor:"#001129", color:"white"}}>
      <h1>Contact Us</h1>
      <ol><li><img src=" " alt=""/> follow us on Instagram</li>
      <li><img src=" " alt=""/> like us on facebook</li>
      <li><img src=" " alt=""/> follow us on Twitter</li></ol>
